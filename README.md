...
|[src/PaprController.sol](https://github.com/with-backed/papr/blob/master/src/PaprController.sol) [🌀](#nowhere "create/create2") [Σ](#nowhere "Unchecked Blocks")|[402](#nowhere "(nSLOC:339, SLOC:402, Lines:560)")|Inherits NFTEDAStarterIncentive, UniswapOracleFundingRateController, and ReservoirOracleUnderwriter. Facilitates deposit and withdrawal of NFTs, minting and burning of papr, and liquidation auctions., &nbsp;&nbsp;[95.33%](#nowhere "(Hit:143 / Total:150)")| `solmate/*` `openzeppelin-contracts/*` `solady/*`|
|_Abstracts (1)_|
